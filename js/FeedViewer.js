...
var FeedViewer = {
	initialise : function()
	{
		//FeedController.clearMyFeedsList();
		$("#stage div").css('display','none');
		$("#news-feeds").css('display','block');

		FeedViewer.initialiseAddFeeds();
		FeedViewer.initialiseMyFeeds();
		FeedViewer.addKeyboardControls();
		FeedViewer.initialiseReaderView();
		FeedViewer.initialiseHeadlineView();
	...
	initialiseHeadlineView : function()
	{
		...
		if($(this).attr('state') == 'notshown')
		{
			$("#rdrheadl").slideDown().show();
			$(this).attr('state','shown');
		}
		else if($(this).attr('state') == 'shown')
		{
			$("#rdrheadl").slideUp();
			$(this).attr('state','notshown');
		}
